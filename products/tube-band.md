...
| 締結 | ボルト＋ナット（上下2点） |
| 構成 | アリガタプレート用／ファインダー台座用／兼用 から選択 |
...
1. **機材全体の写真をお送りください。** 鏡筒と架台が写った写真を何枚かいただければ、鏡筒の形状やファインダーの位置関係を確認できます。
2. **構成をご相談ください。** ファインダーを付けたい、アリガタを兼用にしたい、などご希望をお聞かせください。
3. **こちらで取付箇所を決め、測定箇所をお伝えします。** 写真をもとにバンドを回す位置を定め、「どこを、どの向きで測ってほしいか」を図や写真でご案内しますので、その箇所を実測してお知らせください。
4. **採寸が必要な部品はお送りいただきます。** お手持ちのアリガタプレートやファインダー台座に合わせる場合は、現物を発払い（元払い）でお送りください。
